...
Console.WriteLine(objGeladeira.AdicionarItem(2, 0, 0, objItemMaca));
Console.WriteLine(objGeladeira.AdicionarItem(2, 0, 1, objItemBanana));
Console.WriteLine(objGeladeira.AdicionarItem(2, 1, 2, objItemLaranja));
...
Console.WriteLine(objGeladeira.AdicionarItem(1, 0, 0, objItemLeite));
Console.WriteLine(objGeladeira.AdicionarItem(1, 1, 1, objItemQueijo));
Console.WriteLine(objGeladeira.AdicionarItem(1, 1, 2, objItemMilho));
...
Console.WriteLine(objGeladeira.AdicionarItem(0, 0, 0, objItemPresunto));
Console.WriteLine(objGeladeira.AdicionarItem(0, 0, 1, objItemOvos));
Console.WriteLine(objGeladeira.AdicionarItem(0, 1, 3, objItemCarne));

// mostrar itens no console
Console.WriteLine(objGeladeira.ImprimeConteudo());

Console.WriteLine(objGeladeira.RemoverItem(2, 0, 3)); 

// Remove um item
Console.WriteLine(objGeladeira.RemoverItem(2, 0, 1)); 
...
Console.WriteLine(objGeladeira.AdicionarItem(2, 0, 1, objItemPera));

// limpa o container
Console.WriteLine(objGeladeira.LimparContainer(1, 1));
...
Console.WriteLine(objGeladeira.AddItensAoContainer(1, 0, new List<Item> { objItemIogurte, objItemManteiga, objItemCafe }));
